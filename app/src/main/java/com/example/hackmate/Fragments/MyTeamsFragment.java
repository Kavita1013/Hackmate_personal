...
import com.example.hackmate.particularTeam_leaderviewFragment;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class MyTeamsFragment extends Fragment {

    Button particularTeam, tallyRequest,leaderView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        leaderView = view.findViewById(R.id.leaderView);
        ...
        leaderView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bottomNavigation.setVisibility(View.GONE);
